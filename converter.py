...
import re
import logging
from visualizationVerifier import verify_integrity
# import os
# import sys
from pythonParsers import Cpp

path_of_composed_model = "C:\\Development\\TF\\Alpha\\alpha-rascal\\models\\composed\\Velox.json"
path_of_cleaned_model = "C:\\Development\\TF\\Alpha\\alpha-rascal\\models\\composed\\Velox_clean.json"
path_of_vizualization = "C:\\Development\\TF\\Alpha\\alpha-rascal\\models\\composed\\Velox.copy.viz.json"
...
def main():
    ...
    with open(path_of_cleaned_model, "r") as clean:
        ...
        kind = Cpp      
        converter = kind("C:\\Development\\TF\\Alpha\\alpha-rascal\\models\\composed\\", parsed, None)
