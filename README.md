...
1. **Start Rascal REPL**: Open a command line in the `alpha-rascal` folder and run the command `java -jar rascal-shell-stable.jar` to start a Rascal read-eval-print-loop (REPL).
